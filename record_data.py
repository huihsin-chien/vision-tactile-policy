...
from ImplicitRDP.real_world.teleoperation.data_recorder import DataRecorder
...
def main(args=None):
    ...
    parser.add_argument('--vis_wrench', action='store_true', default=False, help='Whether to visualize the wrench data')
    parser.add_argument('--debug', action='store_true', default=False, help='Whether to print debug messages')
    args = parser.parse_args()
        
    with initialize(config_path='ImplicitRDP/config', version_base="1.1"):
    ...
    base_dir = f'/home/wendi/Desktop/ImplicitRDP/data/{args.save_file_dir}'
