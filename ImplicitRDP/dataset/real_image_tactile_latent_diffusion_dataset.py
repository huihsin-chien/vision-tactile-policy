...
import numpy as np
import tqdm
from ImplicitRDP.model.vae.model import VAE
from ImplicitRDP.dataset.real_image_tactile_dataset import RealImageTactileDataset
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        for data in tqdm.tqdm(self, leave=False, desc='Calculating latent action for normalizer'):
            ...
            if self.at.use_vq:
                ...
                latent_action = self.at.quant_state_without_vq(latent_action)
