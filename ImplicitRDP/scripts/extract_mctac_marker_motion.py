...
VIDEO_DIR = 'data/tactile_video_mctac'
SAVE_DATA_DIR = 'data/tactile_video_mctac'
TAG = 'mctac_v1'
...
def main():
    ...
    for video_path in tqdm.tqdm(video_path_list):
        ...
        node = MCTacCameraPublisher(debug=False,
                                       recorded=True,
                                       dimension=2,
                                       camera_type="MCTac",
        ...
        try:
            while True:
                ...
                # normalization
                initial_markers, marker_motion = marker_normalization(initial_markers, marker_motion,
                                                                      node.dimension, width=node.width, height=node.height)
                # append to the list
