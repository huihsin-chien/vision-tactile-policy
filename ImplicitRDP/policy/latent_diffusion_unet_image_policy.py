...
class LatentDiffusionUnetImagePolicy(DiffusionUnetImagePolicy):
    def __init__(self,
        ...
        if at.use_vq:
            ...
            if at.sample_first:
                ...
                shape_meta['action']['shape'] = [at.n_embed*2]
    ...
    def predict_from_latent_action(self,
        ...
        if not self.at.use_vq:
            latent_action = self.at.postprocess_quant_state_without_vq(latent_action)
        if self.at.use_rnn_decoder:
    ...
    def compute_loss(self, batch):
        ...
        if self.at.use_vq:
            ...
            nlatent_actions = self.at.quant_state_without_vq(nlatent_actions)
