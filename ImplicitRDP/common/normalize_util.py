from ImplicitRDP.model.common.normalizer import SingleFieldLinearNormalizer
from ImplicitRDP.common.pytorch_util import dict_apply, dict_apply_reduce, dict_apply_split
import numpy as np
import torch
...
def get_action_normalizer(actions: np.ndarray, temporally_independent_normalization=False):
    ...
    D = actions.shape[-1]
    if D == 3 or D == 4 or D == 6 or D == 8 or D == 12 or D == 13 or 19:
