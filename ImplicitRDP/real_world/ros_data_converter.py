...
from ImplicitRDP.common.space_utils import ros_pose_to_6d_pose
from ImplicitRDP.common.data_models import SensorMessage
from ImplicitRDP.real_world.real_world_transforms import RealWorldTransforms
from ImplicitRDP.common.visualization_utils import visualize_pcd_from_numpy, visualize_rgb_image
...
class ROS2DataConverter:
    ...
    def convert_robot_states(self, topic_dict: Dict) -> (
            Tuple)[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, bool, bool, Dict]:
    ...
    def convert_all_data(self, topic_dict: Dict) -> SensorMessage:
        ...
        (left_tcp_pose, right_tcp_pose, left_tcp_vel, right_tcp_vel,
         left_tcp_wrench, right_tcp_wrench, left_gripper_state, right_gripper_state) = self.convert_robot_states(topic_dict)
