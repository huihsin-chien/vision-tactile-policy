...
from ImplicitRDP.common.data_models import SensorMessage, SensorMode
from ImplicitRDP.common.visualization_utils import visualize_pcd_from_numpy, visualize_rgb_image
from ImplicitRDP.common.space_utils import pose_6d_to_4x4matrix, pose_6d_to_pose_9d
...
class DataPostProcessingManager:
    ...
    def convert_sensor_msg_to_obs_dict(self, sensor_msg: SensorMessage) -> Dict[str, np.ndarray]:
        ...
        if self.use_6d_rotation:
            obs_dict['left_robot_tcp_pose'] = pose_6d_to_pose_9d(obs_dict['left_robot_tcp_pose'])
            obs_dict['right_robot_tcp_pose'] = pose_6d_to_pose_9d(obs_dict['right_robot_tcp_pose'])
