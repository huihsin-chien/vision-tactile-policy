...
from ImplicitRDP.common.data_models import TactileSensorMessage, Arrow
from ImplicitRDP.common.tactile_marker_utils import marker_normalization
from ImplicitRDP.real_world.publisher.lib import find_marker
from ImplicitRDP.real_world.publisher.gelsight_utility import GelsightUtility
import pyinstrument
...
class GelsightCameraPublisher(Node):
    ...
    def __init__(self,
                 ...
                 teleop_server_ip: str = '192.168.2.242',
...
if __name__ == '__main__':
    ...
    class SchedParam(ctypes.Structure):
        _fields_ = [("sched_priority", ctypes.c_int)]  # define structure field
